...
------------ | ------------- | ------------- | -------------
**length** | **double** | Total length | [optional] 
**elevation** | [**\Infocenter\Client\Model\DsElevation**](DsElevation.md) |  | [optional] 
**first_ascent** | **string** | Time of the first ride towards the destination | [optional] 
**last_ascent** | **string** | Time of the last ride towards the destination | [optional] 
**last_decent** | **string** | Time of the last ride towards the starting point | [optional] 
**number_of_stops** | **int** | The number of stops on a journey or ride. At least two (start and end) is normal but some can have additional stops. | [optional] 
**transport_capacity** | **int** | Number of units, something can transport | [optional] 
