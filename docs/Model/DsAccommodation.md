...
------------ | ------------- | ------------- | -------------
**accommodation_category** | **string** | Official room category HotellerieSuisse for more information check [AccommodataHub documentation](https://docs.discover.swiss/dev/quickstarts/how-to-work-with-accommodatahub/) | [optional] 
**floor_level** | **string** | The floor level for the accommodation in a multi-storey building. | [optional] 
**permitted_usage** | **string** | Indications regarding the permitted usage of the accommodation. | [optional] 
**bed** | [**\Infocenter\Client\Model\DsBedDetails[]**](DsBedDetails.md) | The type of bed or beds for more information check [AccommodataHub documentation](https://docs.discover.swiss/dev/quickstarts/how-to-work-with-accommodatahub/) | [optional] 
**floor_size** | [**\Infocenter\Client\Model\DsQuantitativeValue**](DsQuantitativeValue.md) |  | [optional] 
**number_of_bedrooms** | [**\Infocenter\Client\Model\DsQuantitativeValue[]**](DsQuantitativeValue.md) | The number of bedrooms. | [optional] 
**number_of_rooms** | [**\Infocenter\Client\Model\DsQuantitativeValue[]**](DsQuantitativeValue.md) | The number of rooms. | [optional] 
**number_of_bathrooms** | [**\Infocenter\Client\Model\DsQuantitativeValue[]**](DsQuantitativeValue.md) | The number of bathrooms. | [optional] 
**occupancy** | [**\Infocenter\Client\Model\DsLocationFeatureSpecification[]**](DsLocationFeatureSpecification.md) | The allowed total occupancy for the accommodation in persons. | [optional] 
**lease_length** | [**\Infocenter\Client\Model\DsLocationFeatureSpecification[]**](DsLocationFeatureSpecification.md) | Length of the lease. Includes the minimal length of stay in a certain period of time | [optional] 
**pets_allowed** | **bool** | Indicates whether pets are allowed to enter the accommodation. | [optional] 
**year_built** | **int** | The year an Accommodation was constructed. | [optional] 
**contained_in_lodging_business** | [**\Infocenter\Client\Model\DsLodgingBusinessMember**](DsLodgingBusinessMember.md) |  | [optional] 
