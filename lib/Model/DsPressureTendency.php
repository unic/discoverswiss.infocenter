...
/**
 * DsPressureTendency Class Doc Comment
 *
 * @category Class
 * @package  Infocenter\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DsPressureTendency implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PressureTendency';
    ...
    {
        $this->container['localized_description'] = isset($data['localized_description']) ? $data['localized_description'] : null;
     ...
     *
     * @param string $localized_description localized_description
     *
     * @return $this
     */
