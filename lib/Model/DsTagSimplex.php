...
/**
 * DsTagSimplex Class Doc Comment
 *
 * @category Class
 * @package  Infocenter\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DsTagSimplex implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TagSimplex';
     ...
     * Sets icon_url
     *
     * @param string $icon_url Url to an image that can be displayed for the tag.
     *
     * @return $this
     */
