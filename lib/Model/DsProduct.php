...
class DsProduct implements ModelInterface, ArrayAccess
{
    ...
    {
        return $this->container['item_offered'];
    }

    /**
     * Sets item_offered
     *
     * @param \Infocenter\Client\Model\DsBaseSimplex $item_offered item_offered
     *
     * @return $this
     */
    public function setItemOffered($item_offered)
    {
        $this->container['item_offered'] = $item_offered;
    ...
    {
        return $this->container['is_related_to'];
    }

    /**
     * Sets is_related_to
     *
     * @param \Infocenter\Client\Model\DsProductSimplex[] $is_related_to A pointer to another, somehow related product (or multiple products).
     *
     * @return $this
     */
    public function setIsRelatedTo($is_related_to)
    {
        $this->container['is_related_to'] = $is_related_to;
