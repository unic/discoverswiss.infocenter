...
/**
 * DsTransportationSystem Class Doc Comment
 *
 * @category Class
 * @package  Infocenter\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DsTransportationSystem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransportationSystem';
    ...
    protected static $swaggerFormats = [
        ...
        'last_ascent' => null,
        'last_decent' => null,
        'number_of_stops' => 'int32',
        'transport_capacity' => 'int32',
        'opening_days' => null,
        'accommodation' => null,
    ...
    protected static $setters = [
        ...
        'first_ascent' => 'setFirstAscent',
        'last_ascent' => 'setLastAscent',
        'last_decent' => 'setLastDecent',
        'number_of_stops' => 'setNumberOfStops',
        'transport_capacity' => 'setTransportCapacity',
    ...
    protected static $getters = [
        ...
        'first_ascent' => 'getFirstAscent',
        'last_ascent' => 'getLastAscent',
        'last_decent' => 'getLastDecent',
        'number_of_stops' => 'getNumberOfStops',
        'transport_capacity' => 'getTransportCapacity',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['first_ascent'] = isset($data['first_ascent']) ? $data['first_ascent'] : null;
        $this->container['last_ascent'] = isset($data['last_ascent']) ? $data['last_ascent'] : null;
        $this->container['last_decent'] = isset($data['last_decent']) ? $data['last_decent'] : null;
        $this->container['number_of_stops'] = isset($data['number_of_stops']) ? $data['number_of_stops'] : null;
        $this->container['transport_capacity'] = isset($data['transport_capacity']) ? $data['transport_capacity'] : null;
     ...
     * Sets length
     *
     * @param double $length Total length
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getFirstAscent()
    {
        return $this->container['first_ascent'];
    }

    /**
     * Sets first_ascent
     *
     * @param string $first_ascent Time of the first ride towards the destination
     *
     * @return $this
     */
    public function setFirstAscent($first_ascent)
    {
        $this->container['first_ascent'] = $first_ascent;
     ...
     * @return string
     */
    public function getLastAscent()
    {
        return $this->container['last_ascent'];
    }

    /**
     * Sets last_ascent
     *
     * @param string $last_ascent Time of the last ride towards the destination
     *
     * @return $this
     */
    public function setLastAscent($last_ascent)
    {
        $this->container['last_ascent'] = $last_ascent;
     ...
     * @return string
     */
    public function getLastDecent()
    {
        return $this->container['last_decent'];
    }

    /**
     * Sets last_decent
     *
     * @param string $last_decent Time of the last ride towards the starting point
     *
     * @return $this
     */
    public function setLastDecent($last_decent)
    {
        $this->container['last_decent'] = $last_decent;

        return $this;
    }

    /**
     * Gets number_of_stops
     *
     * @return int
     */
    public function getNumberOfStops()
    {
        return $this->container['number_of_stops'];
    }

    /**
     * Sets number_of_stops
     *
     * @param int $number_of_stops The number of stops on a journey or ride. At least two (start and end) is normal but some can have additional stops.
     *
     * @return $this
     */
    public function setNumberOfStops($number_of_stops)
    {
        $this->container['number_of_stops'] = $number_of_stops;

        return $this;
    }

    /**
     * Gets transport_capacity
     *
     * @return int
     */
    public function getTransportCapacity()
    {
        return $this->container['transport_capacity'];
    }

    /**
     * Sets transport_capacity
     *
     * @param int $transport_capacity Number of units, something can transport
     *
     * @return $this
     */
    public function setTransportCapacity($transport_capacity)
    {
        $this->container['transport_capacity'] = $transport_capacity;
